...
const QString Dialog_login::getUSERNAME()
{
    return this->USERNAME;
}

const QString Dialog_login::getPASSWORD()
{
    return this->PASSWORD;
}

const QString Dialog_login::getServerfield()
{
...
void Dialog_login::on_pushButton_clicked()
{
    ...
    if(this->USERNAME.contains("@")){
       //如果输入的是完整的用户名xxx@xxx.com 则按照@拆分
        ...
        QMessageBox::warning(0,QObject::tr("警告！"),("用户名输入错误！"),QMessageBox::Yes);    //警告对话框
    }
    reject();
}
